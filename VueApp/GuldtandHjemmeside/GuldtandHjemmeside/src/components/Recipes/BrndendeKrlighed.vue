...
<script>
    export default {
        ...
        methods: {
            ...
            fullView() {
                this.$http.get('http://nyguldtand.azurewebsites.net/Recipe/viewASpeceficRecipe?words=lighed' + '&count=' + this.count, {
                    headers: {
            ...
            generateShoppingCart() {
                this.$http.get('http://nyguldtand.azurewebsites.net/Recipe/getShoppingCart?words=lighed' + '&stores=' + this.relevantStores, {
                    headers: {
                        'Access-Control-Allow-Origin': '*',
                    },
